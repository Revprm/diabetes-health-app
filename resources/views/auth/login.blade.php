                    ...
                    <div class="divide-y divide-gray-200">
                        <div
                            ...
                            <form class="space-y-6">
                                <div>
                                    <label for="email"
                                        class="block text-m font-medium text-gray-700 dark:text-gray-300">
                                        Email address
                                    </label>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <label for="remember-me"
                                            class="ml-2 block text-m text-gray-700 dark:text-gray-300">
                                            Remember me
                                        </label>
                                    </div>
                                    <a href="#"
                                        class="text-sm text-green-600 dark:text-green-500 hover:underline">
                                        Forgot password?
                                    </a>
                                </div>
                                <div>
                        ...
                        <div class="pt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="/register" class="text-green-600 dark:text-green-500 hover:underline">Register
                                here</a>
                        </div>
                    </div>
                </div>
