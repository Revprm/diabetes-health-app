    ...
    <div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 p-4 lg:p-6">
        ...
        <div class="max-w-4xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg space-y-6">
            ...
            <form id="createPredictionForm" action="{{ route('admin.prediction.store') }}" method="POST">
                ...
                <!-- User Selection -->
                <div>
                    <label for="create_user" class="block text-xs font-medium text-gray-300 mb-1">User</label>
                ...
                <div class="space-y-6">
                    <div>
                        <label for="create_prediction"
                            class="block text-xs font-medium text-gray-300 mb-1">Prediction</label>
                    ...
                    <div>
                        <label for="create_confidence" class="block text-xs font-medium text-gray-300 mb-1">Confidence
                            (%)</label>
